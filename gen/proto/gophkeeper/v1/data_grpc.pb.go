...
const (
	DataService_Add_FullMethodName    = "/gophkeeper.v1.DataService/Add"
	DataService_Get_FullMethodName    = "/gophkeeper.v1.DataService/Get"
	DataService_List_FullMethodName   = "/gophkeeper.v1.DataService/List"
	DataService_Delete_FullMethodName = "/gophkeeper.v1.DataService/Delete"
)
...
//
// DataService handles CRUD operations for user data.
type DataServiceClient interface {
	// Add creates a new data entry.
	Add(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error)
	// Get retrieves a data entry by ID or title.
	Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error)
	// List returns all data entries for the authenticated user.
	List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error)
	// Delete removes a data entry by ID or title.
...
func (c *dataServiceClient) Add(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AddResponse)
	err := c.cc.Invoke(ctx, DataService_Add_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDataServiceServer) Add(context.Context, *AddRequest) (*AddResponse, error) {
...
func _DataService_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DataServiceServer).Add(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DataService_Add_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataServiceServer).Add(ctx, req.(*AddRequest))
	}
...
var DataService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Add",
			Handler:    _DataService_Add_Handler,
		},
		{
			MethodName: "Get",
	...
	Metadata: "gophkeeper/v1/data.proto",
}
